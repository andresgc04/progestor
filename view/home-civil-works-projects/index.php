...
?>
    ...
    <!-- Head -->
    <head>
        <title>Progestor | Listado De Proyectos</title>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="table-responsive">
                                                    <table id="listadoProyectosDataTable" class="table table-bordered table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
        ...
        <script type="text/javascript" src="home-civil-works-projects.js"></script>
    </body>
