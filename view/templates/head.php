<head>
    ...
    <!-- <title>ProGestor | <%= titleWeb %></title> -->
    ...
    <!-- JQVMap -->
    <!-- <link rel="stylesheet" href="../../../public/public/lib/adminLTE/plugins/jqvmap/jqvmap.min.css" /> -->
    <!-- DataTables -->
    ...
    <link rel="stylesheet" href="../../../public/lib/adminLTE/plugins/datatables-buttons/css/buttons.bootstrap4.min.css" />
    <!-- Theme style -->
    <link rel="stylesheet" href="../../../public/lib/adminLTE/dist/css/adminlte.min.css" />
    <!-- overlayScrollbars -->
    <link rel="stylesheet" href="../../../public/lib/adminLTE/plugins/overlayScrollbars/css/OverlayScrollbars.min.css" />
    <!-- Daterange picker -->
