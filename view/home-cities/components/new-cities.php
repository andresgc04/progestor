<div class="modal fade" id="newCitiesFormModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="newCitiesForm" name="newCitiesForm" method="post">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="nombreCiudad" name="nombreCiudad" class="form-control" placeholder="Ingrese el nombre de la ciudad.">
                            </div>
                        </div>
                    </div>
                </div>
