...
?>
    ...
    <head>
        <title>Progestor | Listado De Usuarios Asignados A Empleados</title>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            ...
                                            <span>Listado De Usuarios Asignados A Empleados</span>
                                        </h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <div class="row mb-4">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="d-flex justify-content-end">
                                                    <button id="newAssignUserEmployeeButton" type="button" class="btn btn-primary">
                                                        <span class="mr-1">Asignar Usuario A Un Empleado</span>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="table-responsive">
                                                    <table id="listadoUsuariosAsignadosEmpleadosDataTable" class="table table-bordered table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                                                <th>EMPLEADOS</th>
        ...
        <script type="text/javascript" src="home-assign-user-employee.js"></script>
    </body>
