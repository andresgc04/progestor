...
?>
    ...
    <head>
        <title>Progestor | Listado De Recursos De Manos De Obras</title>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <section class="col-xl-12 col-lg-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            ...
                                            <span>Listado De Recursos De Manos De Obras</span>
                                        </h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <div class="row mb-4">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="d-flex justify-content-end">
                                                    <button id="newLaborResourcesButton" type="button" class="btn btn-primary">
                                                        <span class="mr-1">Registrar Nuevo Recurso De Mano De Obra</span>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="table-responsive">
                                                    <table id="listadoRecursosManosObrasDataTable" class="table table-bordered table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                                                <th>RECURSOS MANOS DE OBRAS</th>
                                                                <th>TIPO DE PAGO</th>
                                                                <th>COSTO DE PAGO</th>
                                                                <th>ESTADOS</th>
                                                                <th>ACCIONES</th>
                                ...
                                <?php require_once('components/new-labor-resources.php') ?>
                                <?php require_once('components/update-labor-resources.php') ?>
        ...
        <script type="text/javascript" src="new-labor-resources.js"></script>
    </body>
