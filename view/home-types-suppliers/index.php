...
?>
    ...
    <head>
        <title>Progestor | Listado De Tipos De Proveedores</title>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            ...
                                            <span>Listado De Tipos De Proveedores</span>
                                        </h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
        ...
        <script type="text/javascript" src="update-types-suppliers.js"></script>
    </body>
