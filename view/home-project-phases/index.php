...
?>
    ...
    <head>
        <title>Progestor | Listado De Fases Del Proyecto</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <section class="col-xl-12 col-lg-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            ...
                                            <span>Listado De Fases Del Proyecto</span>
                                        </h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <div class="row mb-4">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="d-flex justify-content-end">
                                                    <button id="newProjectPhasesButton" type="button" class="btn btn-primary">
                                                        <span class="mr-1">Registrar Nueva Fase Del Proyecto</span>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="table-responsive">
                                                    <table id="listadoFasesProyectosDataTable" class="table table-bordered table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                ...
                                <?php require_once('components/new-project-phases.php') ?>
                                <?php require_once('components/update-project-phases.php') ?>
