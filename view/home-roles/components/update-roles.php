<div class="modal fade" id="updateRolFormModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="updateRolForm" name="updateRolForm" method="post">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label for="modificarRol">Rol:</label>
                                <input type="text" id="modificarRol" name="modificarRol" class="form-control" placeholder="Ingrese el nombre del rol.">
                            </div>
                        </div>
                    </div>
                </div>
