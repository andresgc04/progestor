...
?>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="d-flex justify-content-end">
                                                    <button id="newProjectRequestsButton" type="button" class="btn btn-primary">
                                                        <span class="mr-1">Registrar Nueva Solicitud De Proyecto</span>
        ...
        <script type="text/javascript" src="home-project-requests.js"></script>
    </body>
