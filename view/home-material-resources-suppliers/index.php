...
?>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <section class="col-xl-12 col-lg-12">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="d-flex justify-content-end">
                                                    <button id="newMaterialResourcesSuppliersButton" type="button" class="btn btn-primary">
                                                        <span class="mr-1">Registrar Nuevo Recurso Material Por Proveedor</span>
                                ...
                                <?php require_once('components/new-material-resources-suppliers.php') ?>
                                <?php require_once('components/update-material-resources-suppliers.php') ?>
        ...
        <script type="text/javascript" src="../../public/js/functions/components_select_list_options/select_list_material_resources_options.js"></script>
