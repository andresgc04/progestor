...
?>
    ...
    <head>
        <title>Progestor | Listado De Tipos De Pagos</title>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <section class="col-xl-12 col-lg-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            ...
                                            <span>Listado De Tipos De Pagos</span>
                                        </h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <div class="row mb-4">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="d-flex justify-content-end">
                                                    <button id="newTypesPaymentsButton" type="button" class="btn btn-primary">
                                                        <span class="mr-1">Registrar Nuevo Tipo De Pago</span>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="table-responsive">
                                                    <table id="listadoTiposPagosDataTable" class="table table-bordered table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                ...
                                <?php require_once('components/new-types-payments.php') ?>
                                <?php require_once('components/update-types-payments.php') ?>
        ...
        <script type="text/javascript" src="home-types-payments.js"></script>
        <script type="text/javascript" src="new-types-payments.js"></script>
    </body>
