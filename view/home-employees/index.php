...
?>
    ...
    <head>
        <title>Progestor | Listado De Empleados</title>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="d-flex justify-content-end">
                                                    <button id="newEmployeesButton" type="button" class="btn btn-primary">
                                                        <span class="mr-1">Registrar Nuevo Empleado</span>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="table-responsive">
                                                    <table id="listadoEmpleadosDataTable" class="table table-bordered table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                                                <th>EMPLEADOS</th>
        ...
        <script type="text/javascript" src="home-employees.js"></script>
    </body>
