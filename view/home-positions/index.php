...
?>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="d-flex justify-content-end">
                                                    <button id="newPositionsButton" type="button" class="btn btn-primary">
                                                        <span class="mr-1">Registrar Nuevo Puesto</span>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="table-responsive">
                                                    <table id="listadoPuestosDataTable" class="table table-bordered table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                                                <th>PUESTOS</th>
        ...
        <script type="text/javascript" src="home-positions.js"></script>
        <script type="text/javascript" src="new-positions.js"></script>
        <script type="text/javascript" src="update-positions.js"></script>
    </body>
