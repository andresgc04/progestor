...
?>
    ...
    <head>
        <title>Progestor | Listado De Módulos Del Sistema</title>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            ...
                                            <span>Listado De Módulos Del Sistema</span>
                                        </h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <div class="row mb-4">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <div class="d-flex justify-content-end">
                                                    <button id="newSystemModulesButton" type="button" class="btn btn-primary">
                                                        <span class="mr-1">Registrar Nuevo Módulo Del Sistema</span>
                                                ...
                                                <div class="table-responsive">
                                                    <table id="listadoModulosDelSistemaDataTable" class="table table-bordered table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                                                <th>M&Oacute;DULOS DEL SISTEMA</th>
                                                                <th>ESTADO</th>
                                                                <th>ACCIONES</th>
                                                            </tr>
                                                        </thead>
        ...
        <script type="text/javascript" src="home-system-modules.js"></script>
        <script type="text/javascript" src="new-system-modules.js"></script>
        <script type="text/javascript" src="update-system-modules.js"></script>
    </body>
