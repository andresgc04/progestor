...
<body>
    <div class="wrapper">
                            ...
                            <div class="col-4">
                                <div class="top-bar-item">
                                    ...
                                    <div class="top-bar-text">
                                        <h3>Horarios:</h3>
                                        <p>Lunes - Viernes, 8:00 A.M. - 9:00 P.M.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4">
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="view/teams/" class="nav-item nav-link">Equipo</a>
                            <a href="view/projects/" class="nav-item nav-link">Proyectos</a>
                            <a href="contact.html" class="nav-item nav-link">Contacto</a>
                        </div>
                        <div class="ml-auto">
                            <a class="btn" href="authentication.php">Acceder</a>
                        </div>
                    </div>
                </nav>
            </div>
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="public/img/carousel-1.jpg" alt="Carousel Image">
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        <p class="animated fadeInRight">Constructor Profesional</p>
                        <h1 class="animated fadeInLeft">Nosotros Construimos Tu Casa</h1>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        <p class="animated fadeInRight">Nosotros Somos De Confianza</p>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-6">
                        <div class="about-img">
                            <img src="public/img/about.jpg" alt="Image">
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-6">
                        <div class="section-header text-left">
                            <p>Bienvenidos A Progestor</p>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item">
                            <div class="service-img">
                                <img src="public/img/service-1.jpg" alt="Image">
                            ...
                            <div class="service-text">
                                ...
                                <a class="btn" href="public/img/service-1.jpg" data-lightbox="service">+</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="service-item">
                            <div class="service-img">
                                <img src="public/img/service-2.jpg" alt="Image">
                                <div class="service-overlay">
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus nec pretium mi. Curabitur facilisis ornare velit non vulputate. Aliquam metus tortor, auctor id gravida condimentum, viverra quis sem.
                                    </p>
                            ...
                            <div class="service-text">
                                <h3>Renovación De Las Casas</h3>
                                <a class="btn" href="public/img/service-2.jpg" data-lightbox="service">+</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item">
                            <div class="service-img">
                                <img src="public/img/service-3.jpg" alt="Image">
                                <div class="service-overlay">
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus nec pretium mi. Curabitur facilisis ornare velit non vulputate. Aliquam metus tortor, auctor id gravida condimentum, viverra quis sem.
                                    </p>
                            ...
                            <div class="service-text">
                                ...
                                <a class="btn" href="public/img/service-3.jpg" data-lightbox="service">+</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="service-item">
                            ...
                            <div class="service-text">
                                ...
                                <a class="btn" href="public/img/service-4.jpg" data-lightbox="service">+</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item">
                            ...
                            <div class="service-text">
                                <h3>Reparación & Soporte</h3>
                                <a class="btn" href="public/img/service-5.jpg" data-lightbox="service">+</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="service-item">
                            ...
                            <div class="service-text">
                                <h3>Pintura</h3>
                                <a class="btn" href="public/img/service-6.jpg" data-lightbox="service">+</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="testimonial-slider-nav">
                            <div class="slider-nav"><img src="public/img/testimonial-1.jpg" alt="Testimonial"></div>
                            <div class="slider-nav"><img src="public/img/testimonial-2.jpg" alt="Testimonial"></div>
                            <div class="slider-nav"><img src="public/img/testimonial-3.jpg" alt="Testimonial"></div>
                            <div class="slider-nav"><img src="public/img/testimonial-4.jpg" alt="Testimonial"></div>
                            <div class="slider-nav"><img src="public/img/testimonial-1.jpg" alt="Testimonial"></div>
                            <div class="slider-nav"><img src="public/img/testimonial-2.jpg" alt="Testimonial"></div>
                            <div class="slider-nav"><img src="public/img/testimonial-3.jpg" alt="Testimonial"></div>
                            <div class="slider-nav"><img src="public/img/testimonial-4.jpg" alt="Testimonial"></div>
        ...
        <div class="blog">
            <div class="container">
                <div class="section-header text-center">
                    <p>Blog M&aacute;s Reciente</p>
                    <h2>Lo &Uacute;ltimo De Nuestro Blog</h2>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="blog-item">
        ...
        <div class="footer wow fadeIn" data-wow-delay="0.3s">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-link">
                            <h2>&Aacute;reas De Servicios</h2>
                            <a href="">Construcción De Edificio</a>
                            <a href="">Renovación De La Casa</a>
                            <a href="">Diseño Arquitect&oacute;nico</a>
            ...
            <div class="container copyright">
                <div class="row">
                    <div class="col-md-12">
                        <p>&copy; <a href="index.php">Progestor</a>, All Right Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
