...
switch ($_GET['op']) {
    ...
    case 'obtener_requerimientos_solicitudes_proyectos_por_solicitud_proyecto_ID':
        ...
        echo json_encode($resultados);
        break;
    case 'obtener_documentos_solicitudes_proyectos_por_solicitud_proyecto_ID':
        ...
        foreach ($datos as $row) {
            ...
            $sub_array[] = $row['ESTADOS'] === 'ACTIVO' ? '<td class="text-right py-0 align-middle">
                                                                <div class="btn-group btn-group-sm">
                                                                    ...
                                                                    <button type="button" id="' . $row['DOCUMENTO_ID'] . '" onclick="eliminarDocumentosSolicitudesProyectos(' . $row['DOCUMENTO_ID'] . ', ' . $row['SOLICITUD_PROYECTO_ID'] . ')"class="btn btn-danger"><i class="fas fa-trash"></i></button>
                                                                </div>
                                                              </td>' :
                '<td class="text-right py-0 align-middle">
                                                                <div class="btn-group btn-group-sm">
                                                                    <button type="button" id="' . $row['DOCUMENTO_ID'] . '" onclick="verDetallesDocumentosSolicitudesProyectos(' . $row['DOCUMENTO_ID'] . ', ' . $row['SOLICITUD_PROYECTO_ID'] . ')" class="btn btn-info disabled"><i class="fas fa-eye"></i></button>
                                                                    <button type="button" id="' . $row['DOCUMENTO_ID'] . '" onclick="eliminarDocumentosSolicitudesProyectos(' . $row['DOCUMENTO_ID'] . ', ' . $row['SOLICITUD_PROYECTO_ID'] . ')"class="btn btn-danger disabled"><i class="fas fa-trash"></i></button>
                                                                </div>
                                                              </td>';
    ...
    case 'obtener_requerimiento_solicitud_proyecto_por_solicitud_proyecto_ID_requerimiento_solicitud_proyecto_ID':
        ...
        break;
    case 'obtener_ruta_documento_solicitud_proyecto_por_documento_ID_solicitud_proyecto_ID':
        $data = $solicitudesProyectos->obtener_ruta_documento_solicitud_proyecto_por_documento_ID_solicitud_proyecto_ID(
            $_POST['documentoID'],
            $_POST['solicitudProyectoID']
        );
