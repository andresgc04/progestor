...
class RecursosMaterialesProyectosObrasCiviles extends Connection
{
    ...
    public function obtener_costos_totales_recursos_materiales_proyectos_obras_civiles_por_proyecto_obra_civil_ID($proyectoObraCivilID)
    {
        $conectar = parent::Connection();
        parent::set_names();

        $query = 'SELECT SUM(COSTO_TOTAL) AS COSTO_TOTAL 
                    FROM RECURSOS_MATERIALES_PROYECTOS_OBRAS_CIVILES
