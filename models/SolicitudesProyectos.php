...
class SolicitudesProyectos extends Connection
{
   ...
   public function obtener_documentos_solicitudes_proyectos_por_solicitud_proyecto_ID($solicitudProyectoID)
   {
      ...
      $query = 'SELECT documentos.DOCUMENTO_ID,
            ...
            INNER JOIN ESTADOS estados
                 ...
                 WHERE documentos.SOLICITUD_PROYECTO_ID = ? 
   ...
   public function modificar_solicitudes_proyectos_cambiar_estado_activo_cancelado_por_solicitud_proyecto_ID(
      ...
      $queryModificarDocumentoSolicitudProyecto = 'UPDATE DOCUMENTOS SET ESTADO_ID = 5, MODIFICADO_POR = ?,
                                                                         FECHA_MODIFICACION = NOW()
                                                                   WHERE SOLICITUD_PROYECTO_ID = ?;';
   ...
   public function modificar_solicitudes_proyectos_cambiar_estado_activo_aprobado_por_solicitud_proyecto_ID(
      ...
      $queryModificarDocumentoSolicitudProyecto = 'UPDATE DOCUMENTOS SET ESTADO_ID = 2, MODIFICADO_POR = ?,
                                                                         FECHA_MODIFICACION = NOW()
                                                                   WHERE SOLICITUD_PROYECTO_ID = ?;';
   ...
   public function modificar_solicitud_proyecto_cambiar_estado_pendiente_aprobado_por_solicitud_proyecto_ID(
      ...
      $queryModificarDocumentoSolicitudProyecto = 'UPDATE DOCUMENTOS SET ESTADO_ID = 7, MODIFICADO_POR = ?,
                                                                         FECHA_MODIFICACION = NOW()
                                                                   WHERE SOLICITUD_PROYECTO_ID = ?;';
